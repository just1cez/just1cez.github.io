...
assert.match(home, /<meta property="og:image" content="https:\/\/just1cez\.github\.io\/images\/avatar\.jpg">/);
...
assert.match(article, /"image":"https:\/\/just1cez\.github\.io\/images\/avatar\.jpg"/);
