...
```cpp title="number-string-sort.cpp"
...
```cpp title="josephus-simulation.cpp"
vector<int> people(n);
...
```cpp title="josephus-recursive.cpp"
int n, k;
cin >> n >> k;
int ans = 0;
for (int i = 2; i <= n; i++) {
